...
if use_custom_dataset:
    # Etiketler sözlüğü
    label_map = {1: "white_region", 2: "dikdortgen", 3: "daire", 4: "ucgen", 5: "kare", 6: "insan", 7: "yazi"}
...
if use_custom_dataset:
    if dataset_is_split:
        ...
        print("Özel veri seti kullanılıyor ancak veri seti bölünmüş değil.")		
    time.sleep(3)
...
print("Model TensorFlow Lite formatına dönüştürülüyor...")
...
print("Dönüştürülen model değerlendiriliyor...")
model.evaluate_tflite(TFLITE_FILENAME, test_data)

# Edge TPU için Derleme (İsteğe Bağlı)
if use_edge_tpu:
    print("Edge TPU aktif ediliyor...")
    print("Edge TPU derleyicisini kullanarak model derleniyor...")
    # !edgetpu_compiler $TFLITE_FILENAME -d --num_segments=$NUMBER_OF_TPUS
    print("Edge TPU derleyicisi kurulu değil, kurulum gerekli.")
